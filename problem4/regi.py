...
app = webapp2.WSGIApplication([('/', MainPage),('/blog/signup', SignupCookiePage),('/blog/welcome',WelcomeCookiePage),('/blog/login', LoginPage),('/blog/logout', LogoutPage),],debug=True)
